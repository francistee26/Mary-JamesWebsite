...
function animateSlides() {
  ...
  sliders.forEach((slide, index, slides) => {
    ...
    // slideTl.fromTo(revealImg, { scale: 2 }, { scale: 1 }, "-=1");
    slideTl.fromTo(img, { scale: 1.8 }, { scale: 1 }, "-=.7");
    slideTl.fromTo(revealText, { x: "0%" }, { x: "100%" }, "-=1");
    slideTl.fromTo(nav, { y: "-100%" }, { y: "0%" }, "-=0.05");
    ...
    pageTl.fromTo(nextSlide, { y: "50%" }, { y: "0%" }, "-=0.4");
    // create a new scene
...
function navToggle(e) {
  if (!e.target.classList.contains("active")) {
    ...
    gsap.to(".line2", 0.5, { rotate: "0", background: "black" });
    ...
    gsap.to(".line2", 0.5, { rotate: "0", background: "#fff" });
    gsap.to(".line3", 0.5, {
      rotate: "0",
      y: 0,
      background: "#fff",
...
function detailAnimation() {
  ...
  slides.forEach((slide, index, slides) => {
    ...
    slideTl.fromTo(nextSlide, { opacity: 0 }, { opacity: 1 }, "-=.8");
    slideTl.fromTo(nextImg, { x: "50%" }, { x: "0%" }, "-=.3");
    // detail scene
